...
jQuery(document).ready(function( $ ) {
  ...
  function checkVisibility() {
    $('.speciality-column, .stats-column').each(function() {
...
jQuery(document).ready(function( $ ) {
    ...
    originalBullets.forEach(function(bullet) {
      ...
      /* $('.feature-item').on('mouseenter', function() {
        ...
        $this.siblings('.feature-item').each(function(index, sibling) {
            let distance = Math.abs($(sibling).index() - $this.index());
        ...
        $this.siblings('.feature-item').each(function(index, sibling) {
            $(sibling).removeClass('reduce-1 reduce-2 reduce-3 reduce-4 reduce-5');
        });
    }); 
...
/********** Resources*****************/
	...
	$('.tags-row .tag').click(function() {
		...
		/* $('.content-section.posts-filter.preload').css('opacity', '0'); 
		$('.content-section.posts-filter').addClass('preload');
		setTimeout(function(){
			$('.content-section.posts-filter').removeClass('preload');
			$('.content-section.posts-filter.preload').css('opacity', '1');
		},1500); */
